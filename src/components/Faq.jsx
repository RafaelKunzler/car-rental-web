...
const Faq = () => {
  ...
  return (   
    ...
    <div className="bg-[url('./car-behind.png')] bg-no-repeat flex bg-left bg-[length:480px_410px]">
        <Accordion type="single" collapsible={false} defaultValue="item1" className="w-full py-20 px-80 ">
            ...
            <AccordionItem  value="item1"  onClick={() => setOpen("1")} >
                        <AccordionTrigger className={open == "1" ? 'bg-orange-600 text-white  hover:no-underline ' : 'hover:no-underline'}>
                            <div className="flex ">
                                <h3 className="text-2xl px-12 ">1. What is special about comparing rental car deals?</h3>
                    ...
                    <AccordionItem value="item2" onClick={() => setOpen("2")}>
                        <AccordionTrigger className={open == "2" ? 'bg-orange-600 text-white hover:no-underline flex' : 'hover:no-underline'}>
                            <div className="flex">
                                <h3 className="text-2xl px-12 ">2. How do I find the car rental deals?</h3>
                    ...
                    <AccordionItem value="item3" onClick={() => setOpen("3")}>
                        <AccordionTrigger className={open == "3" ? 'bg-orange-600 text-white hover:no-underline' : 'hover:no-underline'}>
                            <div className="flex ">
                                <h3 className="text-2xl px-12 ">3. How do I find such low rental car prices?</h3>
